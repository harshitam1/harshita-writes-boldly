      ...
      <section className="relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed font-grotesk">
              Welcome to my corner of the internet where I share thoughts, stories, and the beautifully messy journey of figuring life out
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                to="/about" 
                className="inline-flex items-center px-8 py-4 border-2 border-navy-600 text-navy-700 font-semibold rounded-full hover:bg-navy-50 transition-all duration-200 hover-lift"
              >
                Get to Know Me
              </Link>
            </div>
      ...
      <section className="py-20 bg-white/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link 
              to="/journal"
              className="inline-flex items-center px-6 py-3 text-navy-600 font-semibold hover:text-navy-700 transition-colors"
            >
              View All Posts
              <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
